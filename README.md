...
Semantic HTML is used to markup the importance/meaning of the info in the web page.
2. Name two big differences between ```display: block;``` and ```display: inline;```.
display:block; starts on a new line (div)
display: inline; doesn't start on a new line (span)
3. What are the 4 areas of the box model?
content, padding, border, margin
4. While using flexbox, what axis does the following property work on: ```align-items: center```?
vertical axis
5. Explain why git is valuable to a team of developers.
It's valuable so that everyone can make changes to the code copy and then compare it without altering the original code
